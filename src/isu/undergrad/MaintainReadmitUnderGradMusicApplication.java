...
public class MaintainReadmitUnderGradMusicApplication {
	...
	@Test
	public void MaintainReadmitUnderGradMusicApplicationTest()  {

		try{ 
			String[] workBookNames= {"maintainReadmitUnderGrad"};
			Util util = new Util();

...
public class UnderGradAutomatedDataImpl {
	...
	public List<UnderGradAutomatedData> setData(HSSFWorkbook workbook,String workbookName){
		...
		for (int i=0;i<=worksheet.getLastRowNum();i++)
		{
			if(i==0){
				...
				UnderGradAutomatedData data = new UnderGradAutomatedData();
				HSSFRow row1 = worksheet.getRow(i);

				/*HSSFCell cellA1 = row1.getCell((short) 0);
				String a1Val = cellA1.getStringCellValue();*/

				if(workbookName.equalsIgnoreCase("createApplication"))
				{
					data.setUserid(util.getCellValue(row1.getCell((short)0)));
					data.setPwd(util.getCellValue(row1.getCell((short)1)));
					data.setBirthCountry(util.getCellValue(row1.getCell((short)2)));
					data.setHomeAddress1(util.getCellValue(row1.getCell((short)3)));
					data.setHomeAddressCity(util.getCellValue(row1.getCell((short)4)));
					data.setHomeAddressPostal(util.getCellValue(row1.getCell((short)5)));
					data.setPhone(util.getCellValue(row1.getCell((short)6)));
					data.setEmail(util.getCellValue(row1.getCell((short)7)));
					data.setAppAnswer0(util.getCellValue(row1.getCell((short)8)));
					data.setAppAnswer1(util.getCellValue(row1.getCell((short)9)));
					data.setAppAnswer2(util.getCellValue(row1.getCell((short)10)));
					data.setAppAnswer3(util.getCellValue(row1.getCell((short)11)));
					data.setAppAnswer4(util.getCellValue(row1.getCell((short)12)));
					data.setAppAnswer5(util.getCellValue(row1.getCell((short)13)));
					data.setAppAnswer6(util.getCellValue(row1.getCell((short)14)));
					data.setAppAnswer7(util.getCellValue(row1.getCell((short)15)));
					data.setGpascore(util.getCellValue(row1.getCell((short)16)));
					data.setComptotal(util.getCellValue(row1.getCell((short)17)));
					data.setTest(util.getCellValue(row1.getCell((short)18)));
					data.setScore0(util.getCellValue(row1.getCell((short)19)));
					data.setScore1(util.getCellValue(row1.getCell((short)20)));
					data.setScore2(util.getCellValue(row1.getCell((short)21)));
					dataList.add(data);
				}
				...
				if(workbookName.equalsIgnoreCase("transferUnderGrad") || workbookName.equalsIgnoreCase("readmitUnderGrad") )
				{
